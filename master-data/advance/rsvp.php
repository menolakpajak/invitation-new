...
$hide = '';
$cek_val = 'on';
if(isset($json['switch_rsvp'])){
    if($json['switch_rsvp'] == 'off'){
      $cek = '';
      $hide = 'd-none';
      $iframe = '../../error';
      $cek_val = 'off';
                  ...
                  <div class="d-flex align-items-md-start row">
                    ...
                    <div class="col-sm-6">
                      <div class="card-body">
                        ...
                        <h4 class="text-primary">RSVP</h4>
                      </div>
                        <hr />
                        <div class="mb-2">
                        <strong class="sw-off text-hide">off</strong>
                        <label class="heart-switch">
                            <input name="switch_rsvp" type="checkbox" id="sw-input" value="<?= $cek_val; ?>" <?= $cek; ?>>
                        ...
                        <div class="mb-3 row">
                            <label class="col-md-3 col-form-label">RSVP image</label>
                            <div class="col-md-8">
                              <a class="text-dark text-wrap" href="javascript:void(0)">●<i class="text-danger"> Dipilih secara acak gambar pada galery</i></a><br>
                              <a class="text-dark text-wrap" href="javascript:void(0)">●<i class="text-danger"> Jika Tidak ada gambar di Galery maka akan digunakan gambar default</i></a>
                            </div>
                          </div>
                          <div class="mb-3 row">
                            <label for="rsvp_msg" class="col-md-3 col-form-label">RSVP msg</label>
                            <div class="col-md-8">
                              <textarea id="rsvp_msg" class="form-control" name="rsvp_msg" type="text" rows="3" id="rsvp_msg" placeholder='<?= $default['rsvp_msg']; ?>' ><?= $json['rsvp_msg']; ?></textarea>
                            </div>
                          </div>
                          <div class="mb-2 row">
                            <button class="btn btn-primary w-px-100 " type="button" name="submit" onclick="apply('<?= $user; ?>','rsvp')">Apply</button>
                          </div>
                        </div>
                          <div class="hide-btn mb-2 row d-none">
                            <button class="btn btn-warning w-px-100" type="button" name="submit" onclick="apply('<?= $user; ?>','rsvp')">Apply</button>
                          </div>                                                         
                      </div>
                    </div>
                      <!-- input -->
                    ...
                    <div class="col-sm-12">
                      <div class="card-body">
                        ...
                        <div class="col-6 col-md-3">
                              <a id="prev" href="galery2.php?user=<?= $user; ?>" class="btn btn-gray" style="background-color: #bb818a;" name="previous"><< prev</a>                              
                            </div>
                            <div class="col-6 col-md-3">
                              <a id="next" href="gift.php?user=<?= $user; ?>" class="btn btn-gray" style="background-color: #bb818a;" name="next">Next >></a>                              
                            </div>
                        </div>
                      </div>
                    </div>
