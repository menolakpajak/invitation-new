...
isset($json['galery_path'])){
    $galery = '';
}

// Lokasi path galery2
if(isset($json['switch_galery2']) && 
isset($json['galery_path2'])){
    $galery2 = '';
}
...
//GIFT send
if(isset($json['bank_rek']) &&
isset($json['bank_an']) &&
isset($json['gift_title']) && 
isset($json['gift_alamat'])){
    $gift = '';
}
