                    ...
                    <div class="col-sm-6">
                      <div class="card-body">
                        ...
                        <div id="data-cover" class="text-nowrap">
                          <div class="mb-2 row">
                            <label for="title_cover" class="col-md-3 col-form-label">Title Cover</label>
                            <div class="col-md-6">
                              <input class="form-control" name="title_cover" type="text" placeholder="<?= $default['title']; ?>" id="title_cover" value="<?= $json['title']; ?>"/>
                            </div>
                          </div>
                          <div class="mb-2 row">
                            <label for="cover_name" class="col-md-3 col-form-label">Cover Name</label>
                            <div class="col-md-6">
                              <input class="form-control" name="cover_name" type="text" placeholder="<?= $default['title_name']; ?>" id="cover_name" value="<?= $json['title_name']; ?>"/>
                            </div>
                          </div>
                          <div class="mb-2 row">
                            <label for="cover_img" class="col-md-3 col-form-label">Cover Image</label>
                            <div class="col-md-6">
                              <input class="form-control" name="cover_img" type="file" id="cover_img" accept="image/jpeg" />
                            </div>
                          </div>
                          <div class="mb-2 row">
                            <button class="btn btn-primary w-px-100 " type="button" name="submit" onclick="apply('<?= $user; ?>','cover')">Apply</button>
                          </div>
                        </div>                                                         
                      </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                      <div class="card-body">
                        ...
                        <div class="col-6 col-md-3">
                            ...
                            <div class="col-6 col-md-3">
                              <a id="next" href="qrcode.php?user=<?= $user; ?>" class="btn btn-gray" style="background-color: #bb818a;" name="next">Next >></a>                              
                            </div>
                        </div>
                      </div>
                    </div>
