                  ...
                  <div class="d-flex align-items-md-start row">
                    ...
                    <div class="col-sm-6">
                      <div class="card-body">
                        ...
                        <div class="mb-3 row">
                            <label for="map_view" class="col-md-3 col-form-label font-weight-bold">Map View</label>
                            <div class="col-md-8">
                              <textarea class="form-control" name="map_view" type="text" rows="13" id="map_view" placeholder="Jika Map tidak tampil klik link dibawah atau minta bantuan admin untuk mengisi data Url"><?= $json['map_view']; ?></textarea>
                              <a class="text-dark" href="map-tutorial.php?user=<?= $user; ?>">●<i class="text-primary"> Map Tidak Tampil ?</i></a>
                            </div>
                          </div>
                          <div class="mb-3 row">
                            <label for="map_desc" class="col-md-3 col-form-label">Map Info</label>
                            <div class="col-md-8">
                              <textarea class="form-control" name="map_desc" type="text" rows="4" id="map_desc" placeholder="<?= $default['map_desc']; ?>"><?= $json['map_desc']; ?></textarea>
                            </div>
                          </div>
                          <div class="mb-3 row">
                            <label for="map_loc" class="col-md-3 col-form-label">Map location</label>
                            <div class="col-md-8">
                              <input class="form-control" name="map_loc" type="url" placeholder="<?= $default['map_loc']; ?>" id="map_loc" value="<?= $json['map_loc']; ?>"/>
                            </div>
                          </div>
                          <div class="mb-2 row">
