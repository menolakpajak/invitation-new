                    ...
                    <div class="col-sm-6">
                      <div class="card-body">
                        ...
                        <label class="heart-switch">
                            <input name="switch_quote" type="checkbox" id="sw-input" value="<?= $cek_val; ?>" <?= $cek; ?>>
                        ...
                        <div id="data-quote" class="input-box text-nowrap <?= $hide; ?>">
                        <div class="mb-3 row">
                            <label for="quote_img" class="col-md-3 col-form-label">Quote image</label>
                            <div class="col-md-8">
                              <input class="form-control" name="quote_img" type="file" id="quote_img" accept="image/jpeg"/>
                              <a class="text-dark text-wrap" href="javascript:void(0)">●<i class="text-danger"> Jika Tidak ada gambar maka akan di pilih secara acak gambar dari galery</i></a>
                            </div>
                          </div>
                          <div class="mb-3 row">
                            <label for="quote_isi" class="col-md-3 col-form-label">Quote</label>
                            <div class="col-md-8">
                              <textarea class="form-control" name="quote_isi" type="text" rows="3" id="quote_isi" placeholder='<?= $default['quote_isi']; ?>' ><?= $json['quote_isi']; ?></textarea>
                            </div>
                          </div>
                          <div class="mb-3 row">
                            <label for="quote_arti" class="col-md-3 col-form-label">Arti
                            </label>
                            <div class="col-md-8">
                              <textarea class="form-control" name="quote_arti" type="text" rows="7" id="quote_arti" placeholder="<?= $default['quote_arti']; ?>"><?= $json['quote_arti']; ?></textarea>
                            </div>
                          </div>
                          <div class="mb-3 row">
                            <label for="quote_kutip" class="col-md-3 col-form-label">Kutip</label>
                            <div class="col-md-8">
                              <input class="form-control" name="quote_kutip" type="text" placeholder="<?= $default['quote_kutip']; ?>" id="quote_kutip" value="<?= $json['quote_kutip']; ?>"/>
                            </div>
                          </div>
                          <div class="mb-2 row">
                            <button class="btn btn-primary w-px-100 " type="button" name="submit" onclick="apply('<?= $user; ?>','quote')">Apply</button>
                          </div>
                        </div>
                          <div class="hide-btn mb-2 row d-none">
                            <button class="btn btn-warning w-px-100" type="button" name="submit" onclick="apply('<?= $user; ?>','quote')">Apply</button>
                          </div>                                                         
                      </div>
                    </div>
                      <!-- input -->
                    ...
                    <div class="col-sm-12">
                      <div class="card-body">
                        ...
                        <div class="col-6 col-md-3">
                              <a id="prev" href="song.php?user=<?= $user; ?>" class="btn btn-gray" style="background-color: #bb818a;" name="previous"><< prev</a>                              
                            </div>
                            <div class="col-6 col-md-3">
                              <a id="next" href="couple.php?user=<?= $user; ?>" class="btn btn-gray" style="background-color: #bb818a;" name="next">Next >></a>                              
                            </div>
                        </div>
                      </div>
                    </div>
