                  ...
                  <div class="d-flex align-items-md-start row">
                    ...
                    <div class="col-sm-6">
                      <div class="card-body">
                        ...
                        <h4 class="text-primary">PROKES</h4>
                      </div>
                        <hr />
                        <div class="mb-2">
                        <strong class="sw-off text-hide">off</strong>
                        <label class="heart-switch">
                            <input name="switch_prokes" type="checkbox" id="sw-input" value="<?= $cek_val; ?>" <?= $cek; ?>>
                        ...
                        <div id="data-quote" class="input-box text-nowrap <?= $hide; ?>">
                          <div class="mb-3 row">
                            <label for="prokes_msg" class="col-md-3 col-form-label">Prokes msg</label>
                            <div class="col-md-8">
                              <textarea id="prokes_msg" class="form-control" name="prokes_msg" type="text" rows="7" id="prokes_msg" placeholder='<?= $default['prokes_msg']; ?>' ><?= $json['prokes_msg']; ?></textarea>
                            </div>
                          </div>
                          <div class="mb-2 row">
                            <button class="btn btn-primary w-px-100 " type="button" name="submit" onclick="apply('<?= $user; ?>','prokes')">Apply</button>
                          </div>
                        </div>
                          <div class="hide-btn mb-2 row d-none">
                            <button class="btn btn-warning w-px-100" type="button" name="submit" onclick="apply('<?= $user; ?>','prokes')">Apply</button>
                          </div>                                                         
                      </div>
                    </div>
                      <!-- input -->
                    ...
                    <div class="col-sm-12">
                      <div class="card-body">
                        ...
                        <div class="col-6 col-md-3">
                              <a id="prev" href="map.php?user=<?= $user; ?>" class="btn btn-gray" style="background-color: #bb818a;" name="previous"><< prev</a>                              
                            </div>
                            <div class="col-6 col-md-3">
