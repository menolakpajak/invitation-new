...
>
  <head>
	...
	<link rel="stylesheet" href="../../global/assets/css/picker.css">
...
<!-- proges box -->
				  ...
				  <div class="d-flex align-items-md-start row">
					...
					<div class="col-sm-6">
					  <div class="card-body">
						...
						<h4 class="text-primary">Map</h4>
					  </div>
						<hr />
						<div class="mb-2">
						<strong class="sw-off text-hide">off</strong>
						<label class="heart-switch">
							<input name="switch_map" type="checkbox" id="sw-input" value="<?= $cek_val; ?>" <?= $cek; ?>>
						...
						<div id="data-map" class="input-box text-nowrap <?= $hide; ?>">
						
						<div class="mb-3 row" style="z-index: 2; position: relative;">
						  <label for="mapContainer" class="text-wrap col-md-3 col-form-label">Pilih Lokasi</label>
						  <div>
							<div class="query-box mb-2" style="position: relative; isolation: isolate;">
							  <input id="mapQuery" class="form-control" type="text" rows="10" placeholder="Bali, Denpasar, Indonesia" />
							  <div id="mapQuerySuggestion"></div>
							</div>
							<button id="mapQuerySubmit" style="background-color: #bb818a;" class="btn btn-gray w-px-100 " type="button" name="submit">Search</button>
						  </div>
						</div>

						<div id="mapContainer" class="mb-3 row">
						  <div>
							<div style="width: 100%; aspect-ratio: 1/1;" id="mapPicker"></div>
						  </div>
						</div>
						
						<div class="mb-3 row">
							<label for="map_desc" class="text-wrap col-md-3 col-form-label">Info</label>
							<div class="col-md-8">
							  <textarea class="form-control" name="map_desc" type="text" rows="10" id="map_desc" placeholder="<?= $default['map_desc']; ?>"><?= $json['map_desc']; ?></textarea>
							</div>
						  </div>
						  
						  <div class="mb-2 row">
							<button class="btn btn-primary w-px-100 " type="button" name="submit" onclick="apply('<?= $user; ?>','map')">Apply</button>
						  </div>
						</div>
						  <div class="hide-btn mb-2 row d-none">
							<button class="btn btn-warning w-px-100" type="button" name="submit" onclick="apply('<?= $user; ?>','map')">Apply</button>
						  </div>                                                         
					  </div>
					</div>
					  <!-- input -->
					...
					<div class="col-sm-12">
					  <div class="card-body">
						...
						<div class="col-6 col-md-3">
							  <a id="prev" href="acara.php?user=<?= $user; ?>" class="btn btn-gray" style="background-color: #bb818a;" name="previous"><< prev</a>                              
							</div>
							<div class="col-6 col-md-3">
							  <a id="next" href="prokes.php?user=<?= $user; ?>" class="btn btn-gray" style="background-color: #bb818a;" name="next">Next >></a>                              
							</div>
						</div>
					  </div>
					</div>
  ...
  >
	...
	<script type="text/javascript" src="http://maps.google.com/maps/api/js?key=AIzaSyCAJ34eJzovmU9TQ5EGiqD_Rn9JdvW0wAY"></script>
	<script src="../../global/assets/js/location-picker.js"></script>
	<script src="../../global/assets/js/picker.js?dev=<?= $versi; ?>"></script>
