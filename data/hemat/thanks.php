                  ...
                  <div class="d-flex align-items-md-start row">
                    ...
                    <div class="col-sm-6">
                      <div class="card-body">
                        ...
                        <h4 class="text-primary">Thanks</h4>
                      </div>
                        <hr />          
                        <div id="data-Thanks" class="text-nowrap">
                        <div class="mb-3 row">
                            <label for="thx_txt" class="col-md-3 col-form-label">Kata Penutup</label>
                            <div class="col-md-8">
                              <textarea class="form-control" name="thx_txt" id="thx_txt" rows="8" placeholder="Ucapan Terima kasih dan kata penutup"><?= $json['thx_txt']; ?></textarea>                              
                            </div>
                          </div>
                          <div class="mb-2 row">
                            <button class="btn btn-primary w-px-100 " type="button" name="submit" onclick="apply('<?= $user; ?>','thx')">Apply</button>
                          </div>
                        </div>                                                         
                      </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                      <div class="card-body">
                        ...
                        <div class="col-6 col-md-3">
                            ...
                            <?php if(isset($finish)) :?>
                            <div class="col-6 col-md-3">
                              <a id="next" href="layout.php?user=<?= $user; ?>" class="btn btn-gray" style="background-color: #5eaf58;" name="finish">Layout >></a>                              
                            </div>
                            <?php endif; ?>
                        </div>
                      </div>
