                          ...
                          <!-- boy -->
                            ...
                            <div id="data-acara1" class=" input-box <?=  $hide; ?>">
                              ...
                              <div class="mb-3 row">
                                ...
                                <div class="col-md-8">
                                  <input class="form-control" name="boy" type="text" placeholder="<?= $default['boy']; ?>" id="boy" value="<?= $json['boy']; ?>"/>
                                </div>
                              </div>
                              <div class="mb-3 row">
                                <label for="boy_msg" class="col-md-3 col-form-label">Info</label>
                                <div class="col-md-8">
                                  <textarea class="form-control" name="boy_msg" type="text" rows="4" id="boy_msg" placeholder="<?= $default['boy_msg']; ?>"><?= $json['boy_msg']; ?></textarea>
                                </div>
                              </div>
                            </div>
                            <hr>
                            ...
                            <div id="data-acara2">
                              ...
                              <div class="mb-3 row">
                                ...
                                <div class="col-md-8">
                                  <input class="form-control" name="girl" type="text" placeholder="<?= $default['girl']; ?>" id="girl" value="<?= $json['girl']; ?>"/>
                                </div>
                              </div>
                              <div class="mb-3 row">
                                <label for="girl_msg" class="col-md-3 col-form-label">Info</label>
                                <div class="col-md-8">
                                  <textarea class="form-control" name="girl_msg" type="text" rows="4" id="girl_msg" placeholder="<?= $default['girl_msg']; ?>"><?= $json['girl_msg']; ?></textarea>
                                </div>
                              </div>
                            </div>
                          <div class="mb-2 row">
