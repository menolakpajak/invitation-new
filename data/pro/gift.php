...
$hide = '';
$cek_val = 'on';
if(isset($json['switch_rek'])){
    if($json['switch_rek'] == 'off'){
      $cek = '';
      $hide = 'd-none';
      $iframe = '../../error';
      $cek_val = 'off';
                  ...
                  <div class="d-flex align-items-md-start row">
                    ...
                    <div class="col-sm-6">
                      <div class="card-body">
                        ...
                        <h4 class="text-primary">Detail Gift</h4>
                      </div>
                        <hr />
                        <div class="mb-2">
                        <strong class="sw-off text-hide">off</strong>
                        <label class="heart-switch">
                            <input name="switch_rek" type="checkbox" id="sw-input" value="<?= $cek_val; ?>" <?= $cek; ?>>
                        ...
                        <div id="data-acara" class="input-box text-nowrap <?=  $hide; ?>">
                          <h5 class="text-primary">Amplop Digital</h5>
                          <div id="data-acara1">
                            <div class="mb-3 row">
                              <label for="gift_barcode" class="col-md-3 col-form-label">QR-code</label>
                              <div class="col-md-8">
                                <input class="form-control" name="gift_barcode" type="file" id="gift_barcode" accept="image/jpeg"/>
                              </div>
                            </div>
                            <div class="mb-3 row">
                              <label for="bank_rek" class="col-md-3 col-form-label">No Rek</label>
                              <div class="col-md-8">
                                <input class="form-control" name="bank_rek" type="number" placeholder="<?= $default['bank_rek']; ?>" id="bank_rek" value="<?= $json['bank_rek']; ?>"/>
                              </div>
                            </div>
                            <div class="mb-3 row">
                              <label for="bank_an" class="col-md-3 col-form-label">Atas Nama</label>
                              <div class="col-md-8">
                                <input class="form-control" name="bank_an" type="text" placeholder="<?= $default['bank_an']; ?>" id="bank_an" value="<?= $json['bank_an']; ?>"/>
                              </div>
                            </div>
                          </div>
                            <hr>
                            <h5 class="text-primary">Kirim Kado</h5>
                            <div id="data-acara2">
                              <div class="mb-3 row">
                                <label for="gift_title" class="col-md-3 col-form-label">Title</label>
                                <div class="col-md-8">
                                  <input class="form-control" name="gift_title" type="text" placeholder="<?= $default['gift_title']; ?>" id="gift_title" value="<?= $json['gift_title']; ?>"/>
                                </div>
                              </div>
                              <div class="mb-3 row">
                                <label for="gift_alamat" class="col-md-3 col-form-label">Alamat</label>
                                <div class="col-md-8">
                                  <textarea class="form-control" name="gift_alamat" id="gift_alamat" rows="4" placeholder="<?= $default['gift_alamat']; ?>"><?= $json['gift_alamat']; ?></textarea>
                                </div>
                              </div>
                              
                            </div>
                          <div class="mb-2 row">
                            <button class="btn btn-primary w-px-100 " type="button" name="submit" onclick="apply('<?= $user; ?>','gift')">Apply</button>
                          </div>
                        </div>  
                        <div class="hide-btn mb-2 row d-none">
                            <button class="btn btn-warning w-px-100" type="button" name="submit" onclick="apply('<?= $user; ?>','gift')">Apply</button>
                          </div>                                                       
                      </div>
                    </div>
                      <!-- input -->
                    ...
                    <div class="col-sm-12">
                      <div class="card-body">
                        ...
                        <div class="col-6 col-md-3">
                              <a id="prev" href="rsvp.php?user=<?= $user; ?>" class="btn btn-gray" style="background-color: #bb818a;" name="previous"><< prev</a>                              
                            </div>
                            <div class="col-6 col-md-3">
                              <a id="next" href="thanks.php?user=<?= $user; ?>" class="btn btn-gray" style="background-color: #bb818a;" name="next">Next >></a>                              
                            </div>
                        </div>
                      </div>
                    </div>
