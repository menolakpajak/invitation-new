        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="ms-auto me-auto container-xxl flex-grow-1 container-p-y row">
              <div id="status">
                <?php if(isset($acara)) :?>
                <h4 class="fw-bold px-2 py-2 mb-4 bg-green rounded-2 text-white"><i class='bx bx-check bx-lg'></i> Complete</h4>
                <?php endif; ?>
              </div>
                  ...
                  <div class="d-flex align-items-md-start row">
                    ...
                    <div class="col-sm-6">
                      <div class="card-body">
                        ...
                        <h4 class="text-primary">Detail Acara</h4>
                      </div>
                        <hr />
                        <div class="mb-2">
                        <strong class="sw-off text-hide">off</strong>
                        <label class="heart-switch">
                            <input name="switch_acara" type="checkbox" id="sw-acara" value="<?= $cek_val; ?>" <?= $cek; ?>>
                        ...
                        <strong class="sw-on">on</strong>
                        </div>          
                        <div id="data-acara" class="text-nowrap">
                            <h5 class="text-primary">Acara 1</h5>
                            <div id="data-acara1" class=" input-box <?=  $hide; ?>">
                              <div class="mb-3 row">
                                <label for="acara_title" class="col-md-3 col-form-label">Judul</label>
                                <div class="col-md-8">
                                  <input class="form-control" name="acara_title" type="text" placeholder="<?= $json['acara_title']; ?>" id="acara_title" value="<?= $json['acara_title']; ?>"/>
                                </div>
                              </div>
                              <div class="mb-3 row">
                                <label for="acara_date" class="col-md-3 col-form-label">Tanggal</label>
                                <div class="col-md-8">
                                  <input class="form-control" name="acara_date" type="text" id="acara_date" placeholder="<?= $json['acara_date']; ?>" value="<?= $json['acara_date']; ?>"/>
                                </div>
                              </div>
                              <div class="mb-3 row">
                                <label for="acara_time" class="col-md-3 col-form-label">Waktu</label>
                                <div class="col-md-8">
                                  <input class="form-control" name="acara_time" type="text" id="acara_time" placeholder="<?= $json['acara_time']; ?>" value="<?= $json['acara_time']; ?>"/>
                                </div>
                              </div>
                              <div class="mb-3 row">
                                <label for="acara_alamat" class="col-md-3 col-form-label">Tempat</label>
                                <div class="col-md-8">
                                  <textarea class="form-control" name="acara_alamat" type="text" rows="4" id="acara_alamat" placeholder="<?= $json['acara_alamat']; ?>" ><?= $json['acara_alamat2']; ?></textarea>
                                </div>
                              </div>
                            </div>
                            <hr>
                            <h5 class="text-primary">Acara 2</h5>
                            <div id="data-acara2">
                              <div class="mb-3 row">
                                <label for="acara_title2" class="col-md-3 col-form-label">Judul</label>
                                <div class="col-md-8">
                                  <input class="form-control" name="acara_title2" type="text" placeholder="<?= $json['acara_title2']; ?>" id="acara_title2" value="<?= $json['acara_title2']; ?>"/>
                                </div>
                              </div>
                              <div class="mb-3 row">
                                <label for="acara_date2" class="col-md-3 col-form-label">Tanggal</label>
                                <div class="col-md-8">
                                  <input class="form-control" name="acara_date2" type="text" id="acara_date2" placeholder="<?= $json['acara_date2']; ?>" value="<?= $json['acara_date2']; ?>"/>
                                </div>
                              </div>
                              <div class="mb-3 row">
                                <label for="acara_time2" class="col-md-3 col-form-label">Waktu</label>
                                <div class="col-md-8">
                                  <input class="form-control" name="acara_time2" type="text" id="acara_time2" placeholder="<?= $json['acara_time2']; ?>" value="<?= $json['acara_time2']; ?>"/>
                                </div>
                              </div>
                              <div class="mb-3 row">
                                <label for="acara_alamat2" class="col-md-3 col-form-label">Tempat</label>
                                <div class="col-md-8">
                                  <textarea class="form-control" name="acara_alamat2" type="text" rows="4" id="acara_alamat2" placeholder="<?= $json['acara_alamat2']; ?>"><?= $json['acara_alamat2']; ?></textarea>
                                </div>
                              </div>
                            </div>
                            <div id="countdown">
                              ...
                              <div class="mb-3 row">
                                <label for="acara_cd" class="col-md-3 col-form-label">Countdown <strong class="text-danger">*</strong></label>
                                <div class="col-md-8">
                                  <input class="form-control" name="acara_cd" type="datetime-local" id="acara_cd" value="<?= $json['acara_cd']; ?>"/>
                                </div>
                              </div>
                            </div>
                          <div class="mb-2 row">
                            <button class="btn btn-primary w-px-100 " type="button" name="submit" onclick="apply('<?= $user; ?>','acara')">Apply</button>
                          </div>
                        </div>                                                         
                      </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                      <div class="card-body">
                        ...
                        <div class="col-6 col-md-3">
                              <a id="prev" href="couple.php?user=<?= $user; ?>" class="btn btn-gray" style="background-color: #bb818a;" name="previous"><< prev</a>                              
                            </div>
                            <div class="col-6 col-md-3">
                              <a id="next" href="map.php?user=<?= $user; ?>" class="btn btn-gray" style="background-color: #bb818a;" name="next">Next >></a>                              
                            </div>
                        </div>
                      </div>
                    </div>
