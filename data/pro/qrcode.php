...
if(isset($json['switch_strict'])){
  if($json['switch_strict'] == 'off'){
    $cek_strict = '';
    $hide_strict = 'd-none';
    $cek_val_strict = 'off';
  }
                    ...
                    <div class="col-sm-6">
                      <div class="card-body">
                        ...
                        <label class="heart-switch">
                            <input name="switch_barcode" type="checkbox" id="sw-input" value="<?= $cek_val; ?>" <?= $cek; ?>>
                        ...
                        <div id="data-video" class=" text-nowrap">
                          <div class="mb-3 col border border-label-dark rounded-3 p-2">
                              <label for="video_url" class="col-md-3 col-form-label text-warning"><i class="bx bxs-error bx-sm text-warning" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" title="" data-bs-original-title="<span>Strict Mode</span>">
                              </i> Strict Mode</label>

                              <div class="col-md-12">
                                <!-- switch strict -->
                              <div class="mb-2">
                                <strong class="sw-normal text-hide">normal</strong>
                                <label class="heart-switch">
                                    <input name="switch_strict" type="checkbox" id="sw-strict" value="<?= $cek_val_strict; ?>" <?= $cek_strict; ?>>
                                    <svg viewBox="0 0 33 23" fill="white">
                                        <path d="M23.5,0.5 C28.4705627,0.5 32.5,4.52943725 32.5,9.5 C32.5,16.9484448 21.46672,22.5 16.5,22.5 C11.53328,22.5 0.5,16.9484448 0.5,9.5 C0.5,4.52952206 4.52943725,0.5 9.5,0.5 C12.3277083,0.5 14.8508336,1.80407476 16.5007741,3.84362242 C18.1491664,1.80407476 20.6722917,0.5 23.5,0.5 Z"></path>
                                    </svg>
                                </label>
                                <strong class="sw-strict">strict</strong>
                              </div>
                              <!-- >>>>>>>>>>>>> -->
                                <a class="note text-dark <?= $hide_strict; ?>" href="javascript:void(0)">●<i class="text-danger text-wrap"> Hati-Hati dalam mengaktifkan mode ini !</i></a><br>
                                <a class="note text-dark <?= $hide_strict; ?>" href="javascript:void(0)">●<i class="text-danger text-wrap"> Jika dalam Mode Strict, Maka hanya tamu yang terdaftar saja yang bisa membuka undangan !</i></a>
                              </div>
                            </div>
                            
                          <div class="mb-2 row input-box">
                            <button class="btn btn-primary w-px-100 " type="button" name="submit" onclick="apply('<?= $user; ?>','qrcode')">Apply</button>
                          </div>
                        </div>
                          <div class="hide-btn mb-2 row d-none">
                            <button class="btn btn-warning w-px-100" type="button" name="submit" onclick="apply('<?= $user; ?>','qrcode')">Apply</button>
                          </div>                                                         
                      </div>
                    </div>
                      <!-- input -->
                    ...
                    <div class="col-sm-12">
                      <div class="card-body">
                        ...
                        <div class="col-6 col-md-3">
                              <a id="prev" href="cover.php?user=<?= $user; ?>" class="btn btn-gray" style="background-color: #bb818a;" name="previous"><< prev</a>                              
                            </div>
                            <div class="col-6 col-md-3">
                              <a id="next" href="song.php?user=<?= $user; ?>" class="btn btn-gray" style="background-color: #bb818a;" name="next">Next >></a>                              
                            </div>
                        </div>
                      </div>
                    </div>
