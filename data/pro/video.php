                    ...
                    <div class="col-sm-6">
                      <div class="card-body">
                        ...
                        <label class="heart-switch">
                            <input name="switch_video" type="checkbox" id="sw-input" value="<?= $cek_val; ?>" <?= $cek; ?>>
                        ...
                        <div id="data-video" class="input-box text-nowrap <?= $hide; ?>">
                          <div class="mb-3 row">
                              <label for="video_url" class="col-md-3 col-form-label">Video Url</label>
                              <div class="col-md-8">
                                <input class="form-control" name="video_url" type="url" id="video_url" placeholder="Klik Link dibawah jika tidak tampil" value="<?= $json['vid_src']; ?>"/>
                                <a class="text-dark" href="video-tutorial.php?user=<?= $user; ?>">●<i class="text-primary"> Video Tidak Tampil ?</i></a>
                              </div>
                            </div>
                            <div class="mb-3 row">
                              <label for="video_msg" class="col-md-3 col-form-label">Video Message</label>
                              <div class="col-md-8">
                                <textarea class="form-control" name="vid_msg" type="text" rows="4" id="video_msg" placeholder="<?= $default['vid_msg']; ?>" ><?= $json['vid_msg']; ?></textarea>
                              </div>
                            </div>
                            <div class="mb-3 row">
                              <label for="video_kutip" class="col-md-3 col-form-label">Kutip</label>
                              <div class="col-md-8">
                                <input class="form-control" name="video_kutip" type="text" placeholder="<?= $default['vid_kutip']; ?>" id="video_kutip" value="<?= $json['vid_kutip']; ?>"/>
                              </div>
                            </div>
                          <div class="mb-2 row">
                            <button class="btn btn-primary w-px-100 " type="button" name="submit" onclick="apply('<?= $user; ?>','video')">Apply</button>
                          </div>
                        </div>
                          <div class="hide-btn mb-2 row d-none">
                            <button class="btn btn-warning w-px-100" type="button" name="submit" onclick="apply('<?= $user; ?>','video')">Apply</button>
                          </div>                                                         
                      </div>
                    </div>
                      <!-- input -->
                    ...
                    <div class="col-sm-12">
                      <div class="card-body">
                        ...
                        <div class="col-6 col-md-3">
                              <a id="prev" href="quote.php?user=<?= $user; ?>" class="btn btn-gray" style="background-color: #bb818a;" name="previous"><< prev</a>                              
                            </div>
                            <div class="col-6 col-md-3">
