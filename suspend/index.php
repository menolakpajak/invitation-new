    ...
    <body>
        ...
        <div class="container-xxl container-p-y">
            <div class="misc-wrapper">
                <h2 class="mb-2 mx-2">Suspend</h2>
                <p class="mb-0 mx-2">Maaf Akun Anda Tidak dapat Aktif Sementara Waktu !</p>
                <br />
                <a
                    href="https://api.whatsapp.com/send?phone=62895359797697&text=Halo%20Kak%2C%0AKenapa%20Akun%20Saya%20Ter-Suspend%3F"
                    style="color: white; background-color: #696cff; border-radius: 20px; padding: 8px"
                    target="_blank"
                    ><i class="bx bxl-whatsapp bx-md"></i>Hubungi Admin</a
                >
                <div class="mt-4">
                    <img src="suspend.svg" alt="lock access" width="500" class="img-fluid" />
                </div>
            </div>
        </div>
        <!-- /Under Maintenance -->
