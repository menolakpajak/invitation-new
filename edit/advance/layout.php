                      ...
                      <div class="card-body">
                        ...
                        <div id="data-song" class="text-nowrap">
                          ...
                          <div class="mb-2 row justify-content-around rounded-3 p-2 bg-footer-theme">
                            <button id="save" class="btn btn-primary w-px-100 mb-1" type="button" name="submit" onclick="apply('<?= $user; ?>','layout')">Apply</button>
                            <?php if(isset($finish)) :?>
                            <button class="btn btn-warning w-px-100 mb-1" type="button" name="submit" onclick="apply('<?= $user; ?>','finish')">Reset</button>
                            <?php endif; ?>
                            <a class="btn btn-success w-px-100 mb-1" href="../../admin/" >DONE</a>
                          </div>
                        </div>
                        <!-- ------- -->                                                         
                      </div>
