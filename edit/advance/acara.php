                        ...
                        <div id="data-acara" class="text-nowrap">
                            ...
                            <div id="data-acara1" class=" input-box <?=  $hide; ?>">
                              <div class="mb-3 row">
                                ...
                                <div class="col-md-8">
                                  <input class="form-control" name="acara_title" type="text" id="acara_title" value="<?= $json['acara_title']; ?>"/>
                                </div>
                              </div>
                              <div class="mb-3 row">
                                <label for="acara_date" class="col-md-3 col-form-label">Tanggal</label>
                                <div class="col-md-8">
                                  <input class="form-control" name="acara_date" type="text" id="acara_date" value="<?= $json['acara_date']; ?>"/>
                                </div>
                              </div>
                              <div class="mb-3 row">
                                <label for="acara_time" class="col-md-3 col-form-label">Waktu</label>
                                <div class="col-md-8">
                                  <input class="form-control" name="acara_time" type="text" id="acara_time" value="<?= $json['acara_time']; ?>"/>
                                </div>
                              </div>
                              <div class="mb-3 row">
                                <label for="acara_alamat" class="col-md-3 col-form-label">Tempat</label>
                                <div class="col-md-8">
                                  <textarea class="form-control" name="acara_alamat" type="text" rows="4" id="acara_alamat"><?= $json['acara_alamat2']; ?></textarea>
                                </div>
                              </div>
                            </div>
                            <hr>
                            ...
                            <div id="data-acara2">
                              <div class="mb-3 row">
                                ...
                                <div class="col-md-8">
                                  <input class="form-control" name="acara_title2" type="text" id="acara_title2" value="<?= $json['acara_title2']; ?>"/>
                                </div>
                              </div>
                              <div class="mb-3 row">
                                <label for="acara_date2" class="col-md-3 col-form-label">Tanggal</label>
                                <div class="col-md-8">
                                  <input class="form-control" name="acara_date2" type="text" id="acara_date2" value="<?= $json['acara_date2']; ?>"/>
                                </div>
                              </div>
                              <div class="mb-3 row">
                                <label for="acara_time2" class="col-md-3 col-form-label">Waktu</label>
                                <div class="col-md-8">
                                  <input class="form-control" name="acara_time2" type="text" id="acara_time2" value="<?= $json['acara_time2']; ?>"/>
                                </div>
                              </div>
                              <div class="mb-3 row">
                                <label for="acara_alamat2" class="col-md-3 col-form-label">Tempat</label>
                                <div class="col-md-8">
                                  <textarea class="form-control" name="acara_alamat2" type="text" rows="4" id="acara_alamat2"><?= $json['acara_alamat2']; ?></textarea>
                                </div>
                              </div>
                            </div>
                            <div id="countdown">
