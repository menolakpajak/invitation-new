...
if ($page == 'cover') {
  ...
  $data_use['desc_content'] = ucwords($_POST['cover_name']);
...
if ($page == 'map') {
  ...
  $address = urlencode($_POST['map_desc']);
  $lat = $_POST['lat'];
  $lon = $_POST['lon'];
  $embedGoogle = "https://maps.google.com/maps?q=$lat, $lon&output=embed";

  $share_url = "https://www.google.com/maps/place/{$lat},{$lon}";
  $data_use['map_view'] = $embedGoogle;
  $data_use['map_desc'] = $_POST['map_desc'];
  $data_use['map_loc'] = $share_url;
