                        ...
                        <div id="data-video" class="input-box text-nowrap <?= $hide; ?>">
                          <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                              ...
                              <div class="col-md-8">
                                <textarea class="form-control" name="vid_msg" type="text" rows="4" id="video_msg"><?= $json['vid_msg']; ?></textarea>
                              </div>
                            </div>
                            <div class="mb-3 row">
                              <label for="video_kutip" class="col-md-3 col-form-label">Kutip</label>
                              <div class="col-md-8">
                                <input class="form-control" name="video_kutip" type="text" id="video_kutip" value="<?= $json['vid_kutip']; ?>"/>
                              </div>
                            </div>
                          <div class="mb-2 row">
