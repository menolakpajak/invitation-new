<?php
    ...
    $va           = '1179000817870770'; //get on iPaymu dashboard
    $secret       = 'FCE81893-3039-483A-A39B-56D5ECDD5D75'; //get on iPaymu dashboard
    ...
    //Request Body//
    $body['product']    = array('Paket basic Undangan');
    $body['qty']        = array('1');
    $body['price']      = array('99000');
