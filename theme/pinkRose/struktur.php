...
$frame = <<<frm
<div class="frame">
    <img class="frame-tl animate__animated animate__fadeInLeft animate__slower" src="images/frame/frame-tl.png?versi=$versi" alt="frame" style="width: 70%" />
    <img class="frame-tr animate__animated animate__fadeInRight animate__slower" src="images/frame/frame-tr.png?versi=$versi" alt="frame" style="width: 70%" />
    <img class="frame-bl animate__animated animate__fadeInLeft animate__slower" src="images/frame/frame-bl.png?versi=$versi" alt="frame" style="width: 70%" />
    <img class="frame-br animate__animated animate__fadeInRight animate__slower" src="images/frame/frame-br.png?versi=$versi" alt="frame" style="width: 70%" />
</div>
frm;
                ...
                <div>
                    <div>
                        <div class="embed-couple animate__animated animate__fadeInLeft animate__slower">
                            <img class="photo1 lightbox" src="$boy_img" style="width: 100%; height: 100%; object-fit: cover" />
                        </div>
                        ...
                        <div class="embed-couple animate__animated animate__fadeInRight animate__slower">
                            <img class="photo2 lightbox" src="$girl_img" style="width: 100%; height: 100%; object-fit: cover" />
                        </div>
