...
$frame = <<<frm
        <div class="frame">
            <img class="frame-tl" src="images/frame/frame.png?versi=$versi" alt="frame" />
            <img class="frame-tr" src="images/frame/frame.png?versi=$versi" alt="frame" />
            <img class="frame-bl bottom-frame" src="images/frame/frame.png?versi=$versi" alt="frame" />
            <img class="frame-br bottom-frame" src="images/frame/frame.png?versi=$versi" alt="frame" />
            <img class="frame-tm animate__animated animate__slower" src="images/frame/frame-tm.png?versi=$versi" alt="frame" />
            <img class="frame-bm bottom-frame animate__animated animate__slower" src="images/frame/frame-bm.png?versi=$versi" alt="frame" />
        </div>
        frm;
...
<li class="swiper-slide invitation__slide">
    <div class="container-mobile cover-page" style="background-image: url('images/cover/cover-bg.png'); position: relative; isolation: isolate">
        <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
            <div style="width: 100%;">
                <div class="cover-frame">
                    <div class="cover-frame-tm"></div>
                    <div class="bottom-frame cover-frame-bm"></div>
                </div>
                <div>
                    <div class="animate__animated animate__fadeInUp animate__slower" style="display: flex; justify-content: center; align-items: center; margin-bottom: 2rem;">
                        <img src="$cover_img" style="width: 7rem; border-radius: 50%; aspect-ratio: 1/1; object-fit: cover; " />
                    </div>
                    <div class="text-center animate__animated animate__fadeInDown animate__slower" >
                        <div class="mb-2">$title</div>
                        <div class="font-accent color-accent h1 mb-3" >$title_name</div>
                    </div>
                    <div class="text-center" >
                        <div class="mb-4 animate__animated animate__fadeInUp animate__slower">Kepada Yth;<br />Bapak/Ibu/Saudara/i</div>
                        <div id="guestNameSlot" class="font-accent h3 font-weight-bold mb-4 animate__animated animate__fadeInUp animate__slower">Tamu Undangan</div>
                        <button type="button" style="background-color: var(--inv-accent);" class="btn-open-invitation btn btn-primary rounded-pill mb-4 animate__animated animate__pulse animate__infinite">
                ...
                <div>
                    <div>
                        <div class="embed-couple animate__animated animate__fadeInRight animate__slower">
                            ...
                            <img src="$boy_img" class="lightbox photo2" style="width: 100%; height: 100%; object-fit: cover" />
                        </div>  
                        <div class="text-center animate__animated animate__fadeInRight animate__slower">
                            <div class="font-latin color-accent h1 mb-2">$boy</div>
                            <div>$boy_msg</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-center align-items-center" style="height: 100%">
                <div>
                    <div>
                        ...
                        <div class="text-center animate__animated animate__fadeInRight animate__slower">
                            <div class="font-latin color-accent h1 mb-2">$girl</div>
                            <div>$girl_msg</div>
                        </div>
                    </div>
                </div>
...
<!-- suport -->
<li class="swiper-slide invitation__slide">
    <div class="container-mobile" style="; isolation: isolate;">
        $frame2
        <div class="watermark d-flex justify-content-center align-items-center" style="height: 100%">
            <div swtyle="width: 100%">
                <div class="text-center">
...
<li class="swiper-slide menu-item">
    <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M7.5 6.5C7.5 8.981 9.519 11 12 11s4.5-2.019 4.5-4.5S14.481 2 12 2 7.5 4.019 7.5 6.5zM20 21h1v-1c0-3.859-3.141-7-7-7h-4c-3.86 0-7 3.141-7 7v1h17z" fill="currentColor"></path>
    </svg>
    <span>Host 1</span>
</li>
