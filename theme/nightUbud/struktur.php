...
$frame = <<<frm
        <video style="height:100%; width:100%; object-fit: cover; position: absolute;left:0;top: 0;" loop muted autoplay>
            <source src="images/bg.webm" type="video/webm">
            <source src="images/bg.mp4" type="video/mp4">
            browser anda tidak suport
        </video>
        <div style="position: absolute; pointer-events: none; inset: 0; background: linear-gradient(to bottom, rgb(0 0 0 / .2), 85%, black)"></div>
frm;

$frame2 = <<<frm
        <video style="z-index:-1;height:100%; width:100%; object-fit: cover; position: absolute;left:0;top: 0;" loop muted autoplay>
            <source src="images/bg.webm" type="video/webm">
            <source src="images/bg.mp4" type="video/mp4">
            browser anda tidak suport
        </video>
...
<li class="swiper-slide invitation__slide">
    <div class="container-mobile" style="background-image: url($cover_img); position: relative; isolation: isolate">
        <div style="position: absolute; inset: 0; z-index: -1; background: linear-gradient(to bottom, rgb(0 0 0 / .5), 70%, black)">
        </div>
        <div class="snow-container">
            <div class="snow" style="--scale: .91; --opacity: 1; --x: 0px; --dur: 60s; --delay: 0s; --ax: 100px;"></div>
            <div class="snow" style="--scale: 1.021; --opacity: .75; --x: 500px; --dur: 60s; --delay: 1s; --ax: -299px;"></div>
            <div class="snow" style="--scale: 1.1; --opacity: .91; --x: 250px; --dur: 50s; --delay: 3.15s; --ax: -150px;"></div>
            <div class="snow" style="--scale: 1; --opacity: 1; --x: -100px; --dur: 25s; --delay: 2.4s; --ax: 400px;"></div>
            <div class="snow" style="--scale: 1; --opacity: 1; --x: 50px; --dur: 70s; --delay: 1.25s; --ax: 505px;"></div>
            <div class="snow" style="--scale: .75; --opacity: 1; --x: 700px; --dur: 45s; --delay: 5s; --ax: -300px;"></div>
            <div class="snow" style="--scale: 1.2; --opacity: .5; --x: 450px; --dur: 60s; --delay: 0s; --ax: -200px;"></div>
            <div class="snow" style="--scale: .89; --opacity: .45; --x: 249px; --dur: 25s; --delay: 1s; --ax: 50px;"></div>
            <div class="snow" style="--scale: 1.135; --opacity: 1; --x: 551px; --dur: 29s; --delay: 2.25s; --ax: -115px;"></div>
            <div class="snow" style="--scale: .912; --opacity: .76; --x: 343px; --dur: 15s; --delay: 2s; --ax: -35px;"></div>
            <div class="snow" style="--scale: 1.32; --opacity: .95; --x: 12px; --dur: 30s; --delay: 1.95s; --ax: 70px;"></div>
            <div class="snow" style="--scale: 1.112; --opacity: 1; --x: 435px; --dur: 45s; --delay: 2.12s; --ax: -399px;"></div>
            <div class="snow" style="--scale: .876; --opacity: .243; --x: 312px; --dur: 71s; --delay: 1.23s; --ax: -400px;"></div>
            <div class="snow" style="--scale: 1.2; --opacity: .32; --x: 122px; --dur: 35s; --delay: .253s; --ax: 100px;"></div>
            <div class="snow" style="--scale: .93; --opacity: .55; --x: 531px; --dur: 60s; --delay: 3s; --ax: -231px;"></div>
            <div class="snow" style="--scale: 1.23; --opacity: .35; --x: 315px; --dur: 35s; --delay: 0s; --ax: -212px;"></div>
            <div class="snow" style="--scale: .91; --opacity: 1; --x: 0px; --dur: 60s; --delay: 0s; --ax: 100px;"></div>

            <div class="snow" style="--scale: 1.021; --opacity: .75; --x: 500px; --dur: 60s; --delay: 11s; --ax: -299px;"></div>
            <div class="snow" style="--scale: 1.1; --opacity: .91; --x: 250px; --dur: 50s; --delay: 13.15s; --ax: -150px;"></div>
            <div class="snow" style="--scale: 1; --opacity: 1; --x: -100px; --dur: 25s; --delay: 12.4s; --ax: 400px;"></div>
            <div class="snow" style="--scale: 1; --opacity: 1; --x: 50px; --dur: 70s; --delay: 11.25s; --ax: 505px;"></div>
            <div class="snow" style="--scale: .75; --opacity: 1; --x: 700px; --dur: 45s; --delay: 15s; --ax: -300px;"></div>
            <div class="snow" style="--scale: 1.2; --opacity: .5; --x: 450px; --dur: 60s; --delay: 10s; --ax: -200px;"></div>
            <div class="snow" style="--scale: .89; --opacity: .45; --x: 249px; --dur: 25s; --delay: 11s; --ax: 50px;"></div>
            <div class="snow" style="--scale: 1.135; --opacity: 1; --x: 551px; --dur: 29s; --delay: 12.25s; --ax: -115px;"></div>
            <div class="snow" style="--scale: .912; --opacity: .76; --x: 343px; --dur: 15s; --delay: 12s; --ax: -30px;"></div>
            <div class="snow" style="--scale: 1.32; --opacity: .95; --x: 12px; --dur: 30s; --delay: 11.95s; --ax: 70px;"></div>
            <div class="snow" style="--scale: 1.112; --opacity: 1; --x: 435px; --dur: 45s; --delay: 12.12s; --ax: -399px;"></div>
            <div class="snow" style="--scale: .876; --opacity: .243; --x: 312px; --dur: 71s; --delay: 11.23s; --ax: -400px;"></div>
            <div class="snow" style="--scale: 1.2; --opacity: .32; --x: 122px; --dur: 35s; --delay: 1.253s; --ax: 100px;"></div>
            <div class="snow" style="--scale: .93; --opacity: .55; --x: 531px; --dur: 60s; --delay: 13s; --ax: -231px;"></div>
            <div class="snow" style="--scale: 1.23; --opacity: .35; --x: 315px; --dur: 35s; --delay: 10s; --ax: -212px;"></div>

            <div class="snow" style="--scale: 1.021; --opacity: .75; --x: 500px; --dur: 60s; --delay: 21s; --ax: -299px;"></div>
            <div class="snow" style="--scale: 1.1; --opacity: .91; --x: 250px; --dur: 50s; --delay: 23.15s; --ax: -150px;"></div>
            <div class="snow" style="--scale: 1; --opacity: 1; --x: -100px; --dur: 25s; --delay: 22.4s; --ax: 400px;"></div>
            <div class="snow" style="--scale: 1; --opacity: 1; --x: 50px; --dur: 70s; --delay: 21.25s; --ax: 505px;"></div>
            <div class="snow" style="--scale: .75; --opacity: 1; --x: 700px; --dur: 45s; --delay: 25s; --ax: -300px;"></div>
            <div class="snow" style="--scale: 1.2; --opacity: .5; --x: 450px; --dur: 60s; --delay: 20s; --ax: -200px;"></div>
            <div class="snow" style="--scale: .89; --opacity: .45; --x: 249px; --dur: 25s; --delay: 21s; --ax: 50px;"></div>
        </div>
        <div class="d-flex justify-content-center align-items-center" style="height: 100%;">
            <div style="width: 100%;">
                <div>
                    <div class="text-center text-white animate__animated animate__fadeInDown animate__slower" >
                        <div class="mb-2">$title</div>
                        <div class="font-accent h1 mb-3" >$title_name</div>
                    </div>
                    <div class="text-center text-white" >
                        <div class="mb-4 animate__animated animate__fadeInUp animate__slower">Kepada Yth;<br />Bapak/Ibu/Saudara/i</div>
                        <div id="guestNameSlot" class="h5 font-weight-bold mb-4 animate__animated animate__fadeInUp animate__slower">Tamu Undangan</div>
                ...
                <div>
                    <div>
                        <div class="embed-couple animate__animated animate__fadeInLeft animate__slower">
                            <img src="images/frame/couple-frame.png" class="couple-frame" /> 
        ...
        <div class="watermark d-flex justify-content-center align-items-center" style="height: 100%">
            <div swtyle="width: 100%">
                <div class="text-center">
                    ...
                    <div class="font-accent h2 color-accent animate__animated animate__fadeInUp animate__slow">$title_name</div>
...
<!-- suport -->
<li class="swiper-slide invitation__slide">
    <div class="container-mobile" style="background-image: url(images/bg.jpg); isolation: isolate;">
        $frame2
        <div class="watermark d-flex justify-content-center align-items-center" style="height: 100%">
            <div swtyle="width: 100%">
                <div class="text-center">
            ...
            <div class="quotes mb-3">
                    <svg style="width:50px; opacity: 1;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 405 246.4"><defs><style>.cls-1a{fill:#a27b5c;}.cls-2a{fill:#2c3639;}.cls-3a{fill:#dcd7c9;}</style></defs><g id="Layer_1" data-name="Layer 2"><g id="logo_cerah" data-name="logo cerah">
...
<li class="swiper-slide invitation__slide">
    <div id="barcode" class="container-mobile" style="background-image: url(images/bg.jpg)">
        ...
        <div class="d-flex justify-content-center align-items-center" style="height: 100%">
            <div style="width: 100%">
            <div>
                <div id="bar-code" style="width: 100%; margin: auto; border-radius: 10px; overflow: hidden; margin-bottom: 20px; padding-bottom: 15px;padding-top: 15px; position: relative; background-color:#cac5bfc2;"
