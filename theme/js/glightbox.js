!(function (e, t) {
    ...
    function r(e, t) {
        if (((E(e) || e === window || e === document) && (e = [e]), L(e) || I(e) || (e = [e]), 0 != M(e)))
            ...
            else if (I(e)) for (var s in e) if (P(e, s) && !1 === t.call(e[s], e[s], s, e)) break;
    }
    function a(e) {
            ...
            [
                {
                    ...
                    value: function (e) {
                        if (this.slide.classList.contains("zoomed")) this.active = !1;
                            ...
                            e.target.classList.contains("nodrag") || g(e.target, ".nodrag") || -1 !== ["input", "select", "textarea", "button", "a"].indexOf(t)
                                ? (this.active = !1)
                                : (e.preventDefault(),
                                  (e.target === this.el || ("img" !== t && g(e.target, ".gslide-inline"))) && ((this.active = !0), this.el.classList.add("dragging"), (this.dragContainer = g(e.target, ".ginner-container"))));
                        }
                    },
                },
                {
                ...
                if (
                    ...
                    !u &&
                        (c.match(/(youtube\.com|youtube-nocookie\.com)\/watch\?v=([a-zA-Z0-9\-_]+)/) ||
                            ...
                            c.match(/(youtube\.com|youtube-nocookie\.com)\/shorts\/([a-zA-Z0-9\-_]+)/)) &&
                        (u = "youtube"),
                    "local" === u || !u)
                ) {
                    u = "local";
            ...
            [
                    ...
                    value: function (e) {
                        ...
                        return null !== (e = e.toLowerCase()).match(/\.(jpeg|jpg|jpe|gif|png|apn|webp|avif|svg)/)
                            ...
                            : e.match(/(youtube\.com|youtube-nocookie\.com)\/watch\?v=([a-zA-Z0-9\-_]+)/) ||
                              ...
                              e.match(/(youtube\.com|youtube-nocookie\.com)\/shorts\/([a-zA-Z0-9\-_]+)/) ||
                ...
                },
                {
                    ...
                    value: function (e, t) {
                        ...
                        return (
                            (e.width = P(e, "width") && "" !== e.width ? this.checkSize(e.width) : n),
                            ...
                            if ("external" !== o)
                                return "inline" === o
                                    ? (B.apply(this.instance, [t, s, this.index, v]),
                                      void (s.draggable && new N({ dragEl: t.querySelector(".gslide-inline"), toleranceX: n.dragToleranceX, toleranceY: n.dragToleranceY, slide: t, instance: this.instance })))
                                    : void ("image" !== o
                                          ? C(v) && v()
                                          : D(t, s, this.index, function () {
                                                var i = t.querySelector("img");
                                                s.draggable && new N({ dragEl: i, toleranceX: n.dragToleranceX, toleranceY: n.dragToleranceY, slide: t, instance: e.instance }),
                                                    s.zoomable &&
        ...
        var t,
            ...
            q = new U(X, {
                touchStart: function (t) {
                    if (
                        ((r = !0),
                        (u(t.targetTouches[0].target, "ginner-container") || g(t.targetTouches[0].target, ".gslide-desc") || "a" == t.targetTouches[0].target.nodeName.toLowerCase()) && (r = !1),
                        g(t.targetTouches[0].target, ".gslide-inline") && !u(t.targetTouches[0].target.parentNode, "gslide-inline") && (r = !1),
                        r)
                    ) {
                        if (
                            ((P = t.targetTouches[0]),
                            ...
                            (window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth) > 769 && (h = a.querySelector(".ginner-container")),
                            c(Y, "greset"),
                ...
                touchMove: function (s) {
                    if (r && ((P = s.targetTouches[0]), !b && !S)) {
                        ...
                        var d,
                            ...
                            m = z - u;
                        if (
                            (Math.abs(g) > Math.abs(m) ? ((L = !1), (I = !0)) : ((I = !1), (L = !0)),
                            (t = P.pageX - O.pageX),
                            (E = (100 * t) / l),
                            (i = P.pageY - O.pageY),
                            (A = (100 * i) / o),
                            L && v && ((d = 1 - Math.abs(i) / o), (Y.style.opacity = d), e.settings.touchFollowAxis && (E = 0)),
            ...
            [
                ...
                },
                {
                    ...
                    value: function (e, t) {
                        ...
                        if ((n.offsetWidth > 0 && s && (m(s), (s.style.display = "")), c(e, this.effectsClasses), t))
                            v(e, this.settings.cssEfects[this.settings.openEffect].in, function () {
