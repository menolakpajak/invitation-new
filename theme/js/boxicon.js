                        ...
                        (function (t) {
                            function e() {
                                ...
                                return (
                                    ...
                                    (t._state = { $iconHolder: t.$ui.getElementById("icon"), type: t.getAttribute("type") }),
                                    t
                                );
                            }
                            return (
                                ...
                                u(e, null, [
                                    {
                                        ...
                                        value: function (t, e) {
                                            ...
                                            return (
                                                "solid" === e ? (n = this.cdnUrl + "/solid/bxs-" + t + ".svg") : "logo" === e && (n = this.cdnUrl + "/logos/bxl-" + t + ".svg"),
                                                (n && b[n]) ||
                                        ...
                                        value: function (t, e, n) {
                                            ...
                                            switch (t) {
                                                ...
                                                case "size":
                                                    !(function (t, e, n) {
                                                        var r = t._state;
                                                        r.size && ((r.$iconHolder.style.width = r.$iconHolder.style.height = ""), (r.size = r.sizeType = null)),
                                                            n && !/^(xs|sm|md|lg)$/.test(r.size) && ((r.size = n.trim()), (r.$iconHolder.style.width = r.$iconHolder.style.height = r.size));
                                                    })(this, 0, n);
                                                    break;
                                                case "rotate":
