...
<section id="gallery" class="flex relative isolate section py-[3rem] mt-6 bg-cover bg-gray-100" style="background-image: url('images/cover/cover-bg.png');">
    <div class="container flex flex-col">
        <h2 data-editable="gallery.title" data-aos="fade-up" class="font-[Modernline] my-[3rem] mx-auto text-4xl tablet:text-3xl leading-relaxed tracking-wider text-[var(--accent)]">Momen Bahagia</h2>
