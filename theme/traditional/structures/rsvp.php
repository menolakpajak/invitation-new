...
<section id="rsvp" class="flex flex-col gap-6 relative isolate section pt-4 pb-[6rem]">
    <div class="container flex flex-col gap-4 items-center">
        <div class="text-[var(--accent)] text-center mb-6 mt-6 font-[Modernline] text-4xl phone:text-2xl">Mohon Doa Restu</div>
        <form class="max-w-[40rem] w-full flex flex-col gap-6" id="rsvp-form" autocomplete="off">
            <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-col gap-2 textarea">
            ...
            <button type="submit" class="btn btn-round bg-[var(--primary-btn)] text-white mx-auto active:bg-[var(--primary-btn-active)]" onclick="SubForm()">Kirim Ucapan</button>
        </form>
    </div>

    <div class="container max-w-[50rem] flex justify-center">
        <div class="w-full" id="kolom-ucapan">
            <div class="text-[var(--accent)] text-center mb-6 mt-6 font-[Modernline] text-4xl phone:text-2xl">Ucapan Doa</div>
