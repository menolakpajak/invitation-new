...
// qr-code
(!isset($json['switch_strict'])) ? $json['switch_strict'] = $default['switch_strict'] : '';
(!isset($json['switch_barcode'])) ? $json['switch_barcode'] = $default['switch_barcode'] : '';


//background sound
(!isset($json['song'])) ? $json['song'] = $default['song'] : '';
...
// couple
(!isset($json['switch_couple'])) ? $json['switch_couple'] = $default['switch_couple'] : '';
...
(!isset($json['acara_alamat2'])) ? $json['acara_alamat2'] = $default['acara_alamat2'] : '';
    ...
    //Coundown Acara
(!isset($json['acara_cd'])) ? $json['acara_cd'] = $default['acara_cd'] : '';
...
(!isset($json['switch_rsvp'])) ? $json['switch_rsvp'] = $default['switch_rsvp'] : '';
...
(!isset($json['switch_galery2'])) ? $json['switch_galery2'] = $default['switch_galery2'] : '';
(!isset($json['galery_path2'])) ? $json['galery_path2'] = $default['galery_path2'] : '';
...
// layout
(!isset($json['layout'])) ? $json['layout'] = $default['layout'] : '';
