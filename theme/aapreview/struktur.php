...
// hilangkan class 'BTN_OPEN INVITATION DI' di button COVER SPY TIDAK ERROR';
...
if(!file_exists($quote_image)){
    if (empty($imgs) || empty($quote_image) || $switch_galery == 'off') {
        $rsvp_img1 = 'images/rsvp/img1.jpg';
        $rsvp_img2 = 'images/rsvp/img2.jpg';
        $quote_image = 'images/quote/img.jpg';
    } else {
        $imgs = array_map('basename', $imgs);
        $rsvp_img1 = $galery_path.$imgs[array_rand($imgs)];
        $rsvp_img2 = $galery_path.$imgs[array_rand($imgs)];
        $quote_image = $galery_path.$imgs[array_rand($imgs)];
    }
}else{
    if (empty($imgs) || empty($quote_image)) {
        $rsvp_img1 = 'images/rsvp/img1.jpg';
        $rsvp_img2 = 'images/rsvp/img2.jpg';
    } else {
        $imgs = array_map('basename', $imgs);
    ...
    $quote_image = $quote_image."?versi=$versi";
}
            ...
            <div style="width: 100%">
                <div>
                    ...
                    <div class="text-center">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="margin-bottom: -5px;fill: #ffffff;transform: ;msFilter:;"><path d="M20 4H4c-1.103 0-2 .897-2 2v12c0 1.103.897 2 2 2h16c1.103 0 2-.897 2-2V6c0-1.103-.897-2-2-2zm0 2v.511l-8 6.223-8-6.222V6h16zM4 18V9.044l7.386 5.745a.994.994 0 0 0 1.228 0L20 9.044 20.002 18H4z"></path></svg>
        ...
        <div class="d-flex justify-content-center align-items-center" style="height: 100%">
            <div>
                <div class="embed-quote animate__animated animate__fadeInDown animate__slower">
                    <img class=" mb-4" src="$quote_image" style="width: 100%; height: 100%; object-fit: cover" />
                </div>
            ...
            <div>
                <div>
                    <div class="embed-couple animate__animated animate__fadeInLeft animate__slower">
                        <img src="$boy_img" class="photo1 lightbox" style="width: 100%; height: 100%; object-fit: cover" />
                    </div>
                    ...
                    <div class="embed-couple animate__animated animate__fadeInRight animate__slower">
                        <img src="$girl_img" class="photo2 lightbox" style="width: 100%; height: 100%; object-fit: cover" />
                    </div>
        ...
        <div class="d-flex justify-content-center align-items-center" style="height: 100%">
            ...
            <div class="text-center mb-4 animate__animated animate__fadeInRight animate__slower">
                ...
                <div class="countdown-wrapper d-flex flex-column animate__animated animate__fadeInUp animate__slower" data-datetime="$acara_cd">
                    ...
                    <button class="btn-countdown btn btn-sm btn-pilled btn-accent mt-2">Simpan Tanggal</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-mobile" style="background-image: url(images/bg.jpg)">
        ...
        <div class="d-flex justify-content-center align-items-center" style="height: 100%">
            <div style="width: 100%">
                ...
                <div id="gallery-container" class="d-flex" style="height:65vh; overflow-y:auto;">
gul;
        ...
        if ($i == (count($imgs) - 1)) {
            ...
            <div style="width: 33.333%; overflow: hidden; padding: 4px" class="animate__animated animate__zoomIn animate__slower">
                <div class="" style="overflow: hidden; width: 100%; height: 129px">
                    <img src="$galery_path$imgs[$i]?versi=$versi" style="width: 100%; height: 100%; object-fit: cover" class="lightbox gallery1" />
                </div>
            </div>
            </div>
                </div>
            ...
            <div style="width: 100%">
                <div>
                    ...
                    <div class="text-center">
                        ...
                        <button type="button" class="btn-rsvp btn btn-primary rounded-pill mb-4 animate__animated animate__fadeInUp animate__slow">Kirim Ucapan RSVP</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="d-flex justify-content-center align-items-center" style="height: 100%">
                <div style="width: 100%" class="text-center">
                    ...
                    <div style="display: flex">
                        <button type="button" class="btn-gift btn btn-block btn-primary rounded-pill animate__animated animate__fadeInUp animate__slow" style="max-width: 150px; margin: auto">Amplop Digital</button>
                        <button type="button" class="btn-gift btn btn-block btn-primary rounded-pill animate__animated animate__fadeInUp animate__slow" style="max-width: 150px; margin: auto">Kirim Kado</button>
                    </div>
...
<li class="swiper-slide invitation__slide">
    <div class="container-mobile" style="background-image: url(images/bg.jpg)">
        ...
        <div class="watermark d-flex justify-content-center align-items-center" style="height: 100%">
            ...
            <div class="quotes mb-3">
                    <img class="animate__animated animate__fadeInLeft animate__slower" style="width: 50px;" src="images/icon/logo.png" alt="logo1">
                    <img class="animate__animated animate__fadeInRight animate__slower" style="height: 50px;" src="images/icon/logo2.png" alt="logo2">
            </div>
            <div class="font-italic animate__animated animate__fadeInDown animate__slow">
                <a href="">ada-undangan.online</a> | jasa pembuatan undangan online
            </div>
                    <div class="watermark-placeholder mt-5"></div>
                </div>
            </div>
            ...
            <div>
                <div id="bar-code" style="width: 100%; margin: auto; border-radius: 10px; overflow: hidden; margin-bottom: 20px; padding-bottom: 15px;padding-top: 15px; position: relative; background-color:#ffffffad;"
                    ...
                    <div
                        ...
                        <img id="inerLogo" src="images/icon/logo-barcode.ico" alt="logo-barcode"
