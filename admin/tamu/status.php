...
$status = $_GET['status'];
if($status == 'hadir'){
  $data_tamu = data("SELECT * FROM $cookie WHERE hadir = 'Hadir' ORDER BY dateAdd DESC ");
}
else if($status == 'nohadir'){
  $data_tamu = data("SELECT * FROM $cookie WHERE hadir = 'Tidak Hadir' ORDER BY dateAdd DESC ");
}
else if($status == 'ignore'){
  $data_tamu = data("SELECT * FROM $cookie WHERE status is null ORDER BY dateAdd DESC ");
}
else{
  $data_tamu = data("SELECT * FROM $cookie WHERE status = 'read' ORDER BY dateAdd DESC ");
}
...
<?php 
if($status == 'ignore'){include_once 'ignore.php';}
else if($status == 'hadir'){include_once 'hadir.php';}
else if($status == 'nohadir'){include_once 'nohadir.php';}
else{include_once 'read.php';} 
