...
$data_tamu = data("SELECT * FROM $cookie ORDER BY dateAdd DESC");
$total_tamu = 0;
if(!empty($data_tamu)){
...
>
  <head>
    ...
    <link rel="stylesheet" href="../../theme/aacss/animate.min.css" />
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active open">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="comment.php" class="menu-link d-flex justify-content-between">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Total Tamu /</span> <?= $total_tamu; ?></h4>
              ...
              <div class="d-flex justify-content-between">
                ...
                <div class="col-12 p-2 justify-content-between" >
                  <a class="mt-2 btn btn-success col-5 col-xl-2 col-md-2" href="javascript:void(0)" onclick="tambah('<?= $cookie; ?>')"><i class='bx bx-list-plus'></i> Input Baru</a>
                  <a class="mt-2 btn btn-primary col-5 col-xl-2 col-md-2" href="javascript:void(0)" onclick="template('<?= $cookie; ?>')"><i class='bx bx-book-bookmark'></i> Template</a>
                  <a class="mt-2 btn btn-info col-12 col-xl-2 col-md-2" href="javascript:void(0)" onclick="simple()"><i class='bx bx-share'></i> Link Simple</a>
                </div>
                <div id="simple" class="mt-2 col-12 col-lg-8 p-3 d-none">
                    <input class="col-12 form-control d-inline-block" type="text" value="<?= $copy_link; ?>?to=" readonly>
                    <a class="col-4 btn btn-sm btn-primary w-px-150 rounded-0 rounded-start-bottom rounded-end-bottom mt-n1" 
                    href="<?= $copy_link; ?>?to=" onclick="copyURI(event)"><i class='bx bx-copy'></i> copy link</a>
                </div>
