<div class="col-12 p-2 justify-content-between" >
    ...
    <a style="cursor:default" class="mt-2 btn btn-success col-5 col-xl-2 col-md-2" href="javascript:void(0)"><i class='bx bx-user-plus'></i> Hadir</a>
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody id="container" class="table-border-bottom-0">
                      ...
                      <tr>
                        ...
                        ?></td>
                        <td>
                        <span class="badge text-success">Hadir</span>
