...
>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="bg-pro-only card">
                        <div class="card-body">
                          ...
                          <h3 class="text-warning card-title text-nowrap mb-2">Pro Only</h3>
                ...
                <div class="col-12 col-lg-8 order-2 order-md-3 order-lg-2 mb-4">
                  <div class="card">
                    <div class="row row-bordered g-0">
                      ...
                      <div class="col-md-4">
                        <img class="w-100 p-1 rounded-3" src="../theme/<?= $data[0]['tema']; ?>/images/preview.png" alt="preview picture">
                    ...
                    <div class="col-6 mb-4">
                      <div class="bg-pro-only card">
                        <div class="card-body">
                          ...
                          <h3 class="text-warning card-title mb-2">Pro Only</h3>
  ...
  >
    ...
    <!-- Page JS -->
    <script src="../global/assets/js/dashboards-analytics.js"></script>
