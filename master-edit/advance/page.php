...
?>
            ...
            <!-- head -->
            <li class="menu-item <?php if($page=='head'){echo 'active';} ?>">
                <a
                  href="head.php?user=<?= $user; ?>"
                  class="menu-link"
                >
                <i style="color:#b98890 ;" class="menu-icon bx bx-code-block"></i>
                <div class="w-100 d-flex justify-content-between">
                  <div data-i18n="cover">Head</div>
                  <?php if(isset($head)) :?>
            ...
            <!-- QRCode -->
            <li class="menu-item <?php if($page=='qrcode'){echo 'active';} ?>">
                <a
                  href="qrcode.php?user=<?= $user; ?>"
                  class="menu-link"
                >
                <i style="color:#b98890 ;" class="menu-icon bx bx-qr-scan"></i>
                <div class="w-100 d-flex justify-content-between">
                  <div data-i18n="cover">QR-Code</div>
                  <?php if(isset($qrcode)) :?>
                    <i class='bx bxs-error-circle bx-sm text-warning' data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" title="" data-bs-original-title="<i class='bx bx-error-circle bx-sm pb-md-2 mt-2'></i>
                    <span>Has Changed</span>"></i>
                  <?php endif; ?>
            ...
            <!-- video -->
            <li class="menu-item <?php if($page=='video'){echo 'active';} ?>">
                <a
                  href="video.php?user=<?= $user; ?>"
                  class="menu-link"
                >
                <i style="color:#b98890 ;" class="menu-icon bx bxs-movie-play"></i>
                <div class="w-100 d-flex justify-content-between">
                  <div data-i18n="cover">Video</div>
                  <?php if(isset($video)) :?>
                  <i class='bx bxs-error-circle bx-sm text-warning' data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" title="" data-bs-original-title="<i class='bx bx-error-circle bx-sm pb-md-2 mt-2'></i>
                    <span>Has Changed</span>"></i>
                  <?php endif; ?>
            ...
            <!-- galery -->
            <li class="menu-item <?php if($page=='galery'){echo 'active';} ?>">
                <a
                  href="galery.php?user=<?= $user; ?>"
                  class="menu-link"
                >
                <i style="color:#b98890 ;" class="menu-icon bx bxs-image"></i>
                <div class="w-100 d-flex justify-content-between">
                  <div data-i18n="cover">Galery</div>
                  <?php if(isset($galery)) :?>
                  <i class='bx bxs-error-circle bx-sm text-warning' data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" title="" data-bs-original-title="<i class='bx bx-error-circle bx-sm pb-md-2 mt-2'></i>
                    <span>Has Changed</span>"></i>
                  <?php endif; ?>
            ...
            <!-- galery DUA -->
            <li class="menu-item <?php if($page=='galery2'){echo 'active';} ?>">
                <a
                  href="galery2.php?user=<?= $user; ?>"
                  class="menu-link"
                >
                <i style="color:#b98890 ;" class="menu-icon bx bxs-image"></i>
                <div class="w-100 d-flex justify-content-between">
            ...
            <!-- RSVP -->
            <li class="menu-item <?php if($page=='rsvp'){echo 'active';} ?>">
                <a
                  href="rsvp.php?user=<?= $user; ?>"
                  class="menu-link"
                >
                <i style="color:#b98890 ;" class="menu-icon bx bxs-message-rounded-dots"></i>
                <div class="w-100 d-flex justify-content-between">
                  <div data-i18n="cover">Rsvp</div>
            ...
            <!-- gift -->
            <li class="menu-item <?php if($page=='gift'){echo 'active';} ?>">
                <a
                  href="gift.php?user=<?= $user; ?>"
                  class="menu-link"
                >
                <i style="color:#b98890 ;" class="menu-icon bx bxs-gift"></i>
                <div class="w-100 d-flex justify-content-between">
                  <div data-i18n="cover">Gift</div>
                  <?php if(isset($gift)) :?>
                  <i class='bx bxs-error-circle bx-sm text-warning' data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" title="" data-bs-original-title="<i class='bx bx-error-circle bx-sm pb-md-2 mt-2'></i>
                    <span>Has Changed</span>"></i>
                  <?php endif; ?>
        ...
        <li class="menu-item mt-3">
                <a
                style="background-color: #bcffbc;"
                  href="../../master"
                  class="menu-link rounded-3"
                >
                <i class="menu-icon bx bx-power-off"></i>
                <div class="w-100 d-flex justify-content-between">
                  <div data-i18n="cover"><strong> Done</strong></div>
                </div>
                </a>
            </li>
