                      ...
                      <div class="card-body">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-8">
                              ...
                              <a class="text-dark text-wrap" href="javascript:void(0)">●<i class="text-danger"> Gambar Tidak bisa diReset !</i></a><br>
                          ...
                          <div class="mb-3 row">
                            ...
                            <div class="col-md-8">
                              <textarea class="form-control" name="quote_isi" type="text" rows="3" id="quote_isi"><?= $json['quote_isi']; ?></textarea>
                            </div>
                          </div>
                          <div class="mb-3 row">
                            ...
                            <div class="col-md-8">
                              <textarea class="form-control" name="quote_arti" type="text" rows="7" id="quote_arti"><?= $json['quote_arti']; ?></textarea>
                            </div>
                          </div>
                          <div class="mb-3 row">
                            <label for="quote_kutip" class="col-md-3 col-form-label">Kutip</label>
                            <div class="col-md-8">
                              <input class="form-control" name="quote_kutip" type="text" id="quote_kutip" value="<?= $json['quote_kutip']; ?>"/>
                            </div>
                          </div>
                          <div class="mb-2 row">
