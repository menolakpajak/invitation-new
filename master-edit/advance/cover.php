                      ...
                      <div class="card-body">
                        ...
                        <div id="data-cover" class="text-nowrap">
                          <div class="mb-2 row">
                            ...
                            <div class="col-md-6">
                              <input class="form-control" name="title_cover" type="text" id="title_cover" value="<?= $json['title']; ?>"/>
                            </div>
                          </div>
                          <div class="mb-2 row">
                            <label for="cover_name" class="col-md-3 col-form-label">Cover Name</label>
                            <div class="col-md-6">
                              <input class="form-control" name="cover_name" type="text" id="cover_name" value="<?= $json['title_name']; ?>"/>
                            </div>
                          </div>
                          <div class="mb-2 row">
                    ...
                    <div class="col-sm-12">
                      <div class="card-body">
                        ...
                        <div class="col-6 col-md-3">
                              <a id="prev" href="head.php?user=<?= $user; ?>" class="btn btn-gray" style="background-color: #bb818a;" name="previous"><< prev</a>                              
                            </div>
                            <div class="col-6 col-md-3">
