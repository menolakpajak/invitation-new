                        ...
                        <div id="data-acara" class="input-box text-nowrap <?=  $hide; ?>">
                          ...
                          <div id="data-acara1">
                            ...
                            <div class="mb-3 row">
                              ...
                              <div class="col-md-8">
                                <input class="form-control" name="bank_rek" type="number" id="bank_rek" value="<?= $json['bank_rek']; ?>"/>
                              </div>
                            </div>
                            <div class="mb-3 row">
                              <label for="bank_an" class="col-md-3 col-form-label">Atas Nama</label>
                              <div class="col-md-8">
                                <input class="form-control" name="bank_an" type="text" id="bank_an" value="<?= $json['bank_an']; ?>"/>
                              </div>
                            </div>
                          </div>
                            <hr>
                            ...
                            <div id="data-acara2">
                              <div class="mb-3 row">
                                ...
                                <div class="col-md-8">
                                  <input class="form-control" name="gift_title" type="text" id="gift_title" value="<?= $json['gift_title']; ?>"/>
                                </div>
                              </div>
                              <div class="mb-3 row">
                                <label for="gift_alamat" class="col-md-3 col-form-label">Alamat</label>
                                <div class="col-md-8">
                                  <textarea class="form-control" name="gift_alamat" id="gift_alamat" rows="4"><?= $json['gift_alamat']; ?></textarea>
                                </div>
                              </div>
