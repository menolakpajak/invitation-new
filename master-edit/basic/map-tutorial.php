                      ...
                      <div class="card-body">
                        ...
                        <div id="map-phone" class="input-box text-nowrap">
                          ...
                          <div>
                            ...
                            <p class="mb-0 text-wrap"><strong>5.</strong> Paste <strong class="text-primary">Alamat lengkap</strong> tadi ke dalam kolom dibawah ini lalu klik tombol <strong class="text-primary">Generate Link</strong>.
                            ...
                            <p class="mb-0 text-wrap"><strong>6.</strong> Jika Kolom Result sudah mengenerate link, tekan tombol <strong class="text-primary">Copy Link</strong> .</p>
                              <div class="mb-1 row">
                            ...
                            <p class="mb-0 text-wrap"><strong>7.</strong> Terakhir <strong class="text-primary">Tempelkan</strong> link yang sudah anda copy tadi, dan klik <strong class="text-primary">APPLY</strong> untuk memastikan MAP yang anda ingin tampilkan telah Tertampil dengan Baik.</p>
