                  ...
                  <div class="d-flex align-items-md-start row">
                    ...
                    <div class="col-sm-6">
                      <div class="card-body">
                        ...
                        <h4 class="text-primary">Cover</h4>
                      </div>
                        <hr />          
                        <div id="data-cover" class="text-nowrap">
                          <div class="mb-2 row">
                            <label for="title_head" class="col-md-3 col-form-label">Title Head</label>
                            <div class="col-md-6">
                              <input class="form-control" name="title_head" type="text" id="title_head" value="<?= $json['title_head']; ?>"/>
                            </div>
                          </div>
                          <div class="mb-2 row">
                            <label for="title_content" class="col-md-3 col-form-label">Title Content</label>
                            <div class="col-md-6">
                              <input class="form-control" name="title_content" type="text" id="title_content" value="<?= $json['title_content']; ?>"/>
                            </div>
                          </div>
                          <div class="mb-2 row">
                            <label for="url_content" class="col-md-3 col-form-label">URL Content</label>
                            <div class="col-md-6">
                              <input class="form-control" name="url_content" type="url" id="url_content" value="<?= $json['url_content']; ?>"/>
                            </div>
                          </div>
                          <div class="mb-2 row">
                            <label for="desc_content" class="col-md-3 col-form-label">Desc Content</label>
                            <div class="col-md-6">
                              <textarea class="form-control" name="desc_content" type="text" rows="7" id="desc_content"><?= $json['desc_content']; ?></textarea>
                            </div>
                          </div>
                          <div class="mb-2 row border border-1 rounded-2 bg-light">
                            <div class="mb-2 row">
                              <label for="img_content" class="col-md-3 col-form-label">IMG Content</label>
                              <div class="col-md-12">
                                <input class="form-control" name="img_content" type="url" id="img_content" value="<?= $json['img_content']; ?>"/>
                              </div>
                            </div>
                            <div class="mb-2 row">
                              <label for="head_img" class="col-md-3 col-form-label">Image File</label>
                              <div class="col-md-12">
                                <input class="form-control" name="head_img" type="file" id="head_img" accept="image/jpeg" />
                                <a class="text-dark text-wrap" href="javascript:void(0)">●<i class="text-danger"> Gambar Tidak bisa diReset !</i></a>
                              </div>
                            </div>
                          </div>
                          <div class="mb-2 row">
                            <button class="btn btn-primary w-px-100 " type="button" name="submit" onclick="apply('<?= $user; ?>','head')">Apply</button>
                          </div>
                        </div>                                                         
                      </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                      <div class="card-body">
                        ...
                        <div class="col-6 col-md-3">
                              <a id="prev" href="./?user=<?= $user; ?>" class="btn btn-gray" style="background-color: #bb818a;" name="previous"><< prev</a>                              
                            </div>
                            <div class="col-6 col-md-3">
                              <a id="next" href="cover.php?user=<?= $user; ?>" class="btn btn-gray" style="background-color: #bb818a;" name="next">Next >></a>                              
                            </div>
                        </div>
                      </div>
                    </div>
