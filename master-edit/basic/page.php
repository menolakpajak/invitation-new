...
?>
            ...
            <li class="menu-item <?php if($page=='detail'){echo 'active';} ?>">
                <a
                  ...
                  class="menu-link"
                >
                <i class="menu-icon bx bxs-detail"></i>
            ...
            <li class="menu-item <?php if($page=='head'){echo 'active';} ?>">
                <a
                  ...
                  class="menu-link"
                >
                <i class="menu-icon bx bx-code-block"></i>
                <div class="w-100 d-flex justify-content-between">
            ...
            <li class="menu-item <?php if($page=='song'){echo 'active';} ?>">
                <a
                  ...
                  class="menu-link"
                >
                <i class="menu-icon bx bxs-music"></i>
                <div class="w-100 d-flex justify-content-between">
            ...
            <li class="menu-item <?php if($page=='video'){echo 'active';} ?>">
                <a
                  ...
                  class="menu-link"
                >
                <i class="menu-icon bx bxs-movie-play"></i>
                <div class="w-100 d-flex justify-content-between">
            ...
            <li class="menu-item <?php if($page=='couple'){echo 'active';} ?>">
                <a
                  ...
                  class="menu-link"
                >
                <i class="menu-icon bx bxs-heart-circle"></i>
                <div class="w-100 d-flex justify-content-between">
            ...
            <li class="menu-item <?php if($page=='galery'){echo 'active';} ?>">
                <a
                  ...
                  class="menu-link"
                >
                <i class="menu-icon bx bxs-image"></i>
                <div class="w-100 d-flex justify-content-between">
            ...
            <li class="menu-item <?php if($page=='rsvp'){echo 'active';} ?>">
                <a
                  ...
                  class="menu-link"
                >
                <i class="menu-icon bx bxs-message-rounded-dots"></i>
                <div class="w-100 d-flex justify-content-between">
            ...
            <li class="menu-item <?php if($page=='thanks'){echo 'active';} ?>">
                <a
                  ...
                  class="menu-link"
                >
                <i class="menu-icon bx bxs-badge-check"></i>
                <div class="w-100 d-flex justify-content-between">
            ...
            <li class="menu-item <?php if($page=='layout'){echo 'active';} ?>">
                <a
                  ...
                  class="menu-link"
                >
                <i class="menu-icon bx bxs-layout"></i>
                <div class="w-100 d-flex justify-content-between">
