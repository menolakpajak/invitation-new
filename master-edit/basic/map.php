                      ...
                      <div class="card-body">
                        ...
                        <div class="mb-3 row">
                          ...
                          <div class="mb-3 row">
                            ...
                            <div class="col-md-8">
                              <textarea class="form-control" name="map_desc" type="text" rows="4" id="map_desc"><?= $json['map_desc']; ?></textarea>
                            </div>
                          </div>
                          <div class="mb-3 row">
                            <label for="map_loc" class="col-md-3 col-form-label">Map location</label>
                            <div class="col-md-8">
                              <input class="form-control" name="map_loc" type="url" id="map_loc" value="<?= $json['map_loc']; ?>"/>
                            </div>
                          </div>
                          <div class="mb-2 row">
